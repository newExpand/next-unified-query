...
interface BaseQueryObserverOptions<T = any> {
	...
	placeholderData?:
		| T
		| React.ReactNode
		| ((prevData: T | React.ReactNode | undefined, prevQuery?: QueryState<T> | undefined) => T | React.ReactNode);
	gcTime?: number;
}
 ...
 */
export type QueryObserverOptions<T = any> = UrlBasedQueryObserverOptions<T> | FunctionBasedQueryObserverOptions<T>;
