...
import { QueryClientProvider, useQueryClient } from "../src/react";
...
describe("QueryClientProvider 중첩 및 fetcher 분기", () => {
	it("Provider별로 fetcher 옵션이 다르게 적용된다", () => {
		...
		expect(screen.getAllByText(/baseURL:/)[0]).toHaveTextContent("https://api.main.com");
		expect(screen.getAllByText(/baseURL:/)[1]).toHaveTextContent("https://api.sub.com");
	});
});
