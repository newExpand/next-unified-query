import { z } from "zod";
import type { CancelableRequest, FetchConfig, RequestConfig, ZodResponse } from "../types/index.js";
import { ContentType, ResponseType } from "../types/index.js";
			...
			try {
				...
				if (error instanceof Error && error.name === "AbortError") {
					return {
						data: null,
						error: {
							message: isCanceled ? "Request was canceled" : "Request timed out",
							raw: error,
						},
						status: 0,
						headers: new Headers(),
				...
				return {
					data: null,
					error: {
						message: processedError instanceof Error ? processedError.message : "Request failed",
						raw: processedError,
					},
